...
formVendaProduto.addEventListener('submit', function(event) {
  ...
  if (vendaAVista && vendaAPrazo) {
    alert("Por favor, selecione apenas uma opção de venda.");
    return;
  } else if (vendaAVista) {
...
window.onclick = function(event) {
  const modals = [modalCadastroProduto, modalVendaProduto, modalCadastroCliente, modalCadastroFornecedor, modalCadastroBens, modalRelatorios];
